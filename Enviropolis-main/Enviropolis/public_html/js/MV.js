...
function transformPoint(m, v) {
    ...
    const v1 = v[1];
    const v2 = v[2];
    const d = v0 * m[0][3] + v1 * m[1][3] + v2 * m[2][3] + m[3][3];
    
    dst[0] = (v0 * m[0][0] + v1 * m[1][0] + v2 * m[2][0] + m[3][0]) / d;
    dst[1] = (v0 * m[0][1] + v1 * m[1][1] + v2 * m[2][1] + m[3][1]) / d;
    dst[2] = (v0 * m[0][2] + v1 * m[1][2] + v2 * m[2][2] + m[3][2]) / d;
